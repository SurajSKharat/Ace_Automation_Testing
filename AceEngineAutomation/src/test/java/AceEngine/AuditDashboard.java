...
public class AuditDashboard {
	...
	public void auditDashboard1() throws InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver",
				"D:\\Automation Project\\AceEngineAutomation\\driver\\chromedriver.exe");
		...
		Thread.sleep(20000);
		driver.findElement(By.xpath("//li[@aria-label = 'System-2']")).click();
		Thread.sleep(10000);
		driver.findElement(By.xpath("//div [text ()= 'Audit Dashboard']")).click();

		Thread.sleep(10000);
		driver.findElement(By.xpath("//span[text ()= 'Test CIS']")).click();
		Thread.sleep(10000);
